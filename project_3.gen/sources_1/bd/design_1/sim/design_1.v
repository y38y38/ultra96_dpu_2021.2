...
module design_1
  ...
  design_1_dpuczdx8g_0_0 dpuczdx8g_0
       (.dpu0_interrupt(dpuczdx8g_0_dpu0_interrupt),
        ...
        .dpu_2x_clk(clk_wiz_0_aclk_2x),
        .dpu_2x_resetn(proc_sys_reset_0_peripheral_aresetn),
        .m_axi_dpu_aclk(clk_wiz_0_aclk),
        .m_axi_dpu_aresetn(proc_sys_reset_1_peripheral_aresetn),
  ...
  design_1_proc_sys_reset_0_0 proc_sys_reset_0
       (.aux_reset_in(1'b1),
        ...
        .slowest_sync_clk(clk_wiz_0_aclk_2x));
  design_1_proc_sys_reset_1_0 proc_sys_reset_1
       (.aux_reset_in(1'b1),
        ...
        .slowest_sync_clk(clk_wiz_0_aclk));
  ...
  design_1_zynq_ultra_ps_e_0_0 zynq_ultra_ps_e_0
       (.maxigp2_araddr(zynq_ultra_ps_e_0_M_AXI_HPM0_LPD_ARADDR),
        ...
        .saxihp0_fpd_aclk(clk_wiz_0_aclk),
        .saxihp1_fpd_aclk(clk_wiz_0_aclk),
        .saxihp2_fpd_aclk(clk_wiz_0_aclk));
endmodule
